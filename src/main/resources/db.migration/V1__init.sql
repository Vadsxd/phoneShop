...
alter table if exists subcategory add constraint fk_subcategory_id foreign key (subcategory_id) references product;
alter table if exists category add constraint fk_category_id foreign key (category_id) references subcategory;
