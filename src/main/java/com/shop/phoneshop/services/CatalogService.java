...
public class CatalogService {
    ...
    private CatalogDto getCatalogDto(JwtAuthentication authentication, List<Product> products) {
        ...
        return CatalogMapper.fromProductDtosAndUserProductsToCatalogDto(productDtos, userProducts);
    }
    ...
    public CatalogDto getProduct(Long id, JwtAuthentication authentication) {
        ...
        return CatalogMapper.fromProductDtoAndUserProductsToCatalogDto(productDto, userProducts);
    }
